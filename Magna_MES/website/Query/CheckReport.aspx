    ...
    <div class="top">
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td style="width: 150px;">
                    <input type="button" class="topsearchBtn" href="javascript:;" onclick="searchInfos(1,1)" value="查询"/></td>

                <td style="width: 150px;">
                    <a  class="topexcelBtn" href="javascript:;" onclick="excelForm()">导出Excel</a></td>
            </tr>
            <tr>
