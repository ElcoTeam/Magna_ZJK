  ...
  <a style="font-size: 12px; font-weight: 700; color: #000000" class="easyui-linkbutton" href="javascript:;" onclick="excelForm()">导出Excel</a></span></div>
    ...
    <div id="w" style="padding: 0px; visibility: hidden" title="零件编辑">
        <table cellpadding="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td>
                    <select id="bom_prop" class="easyui-combobox" style="width: 230px; height: 25px;"
                        data-options="valueField: 'prop_id',textField: 'prop_name'">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select id="bom_suppllerid" class="easyui-combobox" style="width: 230px; height: 25px;"
                        data-options="valueField: 'supplierid',textField: 'suppliername'">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#bom_prop").combobox({
                onChange: function (n, o) {                   
                    $('#bom_suppllerid').combobox('reload', '/HttpHandlers/MaterialPropertyHandler.ashx?method=querySupplierForBOM&id='+n);
                }
            });
            ...
            dg = $('#tb').datagrid({
               ...
               // fitColumns: true,
                columns: [[
                      ...
                      { field: 'bom_propid', title: '外库id', hidden: true },
                      ...
                      //{ field: 'allpartNOs', title: '整车座椅NO集合', hidden: true },
                       ...
                       { field: 'bom_propname', title: '外库编号', align: "center", width: 200 },
                       { field: 'bom_suppller', title: '供应商编号', align: "center", width: 200 },
        ...
        function saveBOM() {
            ...
            var bom_prop = $('#bom_prop').combo('getValue');
        ...
        function reloadbom_suppllerid() {
            $('#bom_suppllerid').combobox('reload', '/HttpHandlers/MaterialPropertyHandler.ashx?method=querySupplierForBOM&id=1');
        }
        function reloadbom_prop() {
            $('#bom_prop').combobox('reload', '/HttpHandlers/MaterialPropertyHandler.ashx?method=querypropForBOM&id=1');
        }
