<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" Inherits="foundation_FlowLine1" ValidateRequest="false" CodeBehind="FlowLine.aspx.cs"  %>
        ...
        <table cellpadding="0" cellspacing="0" table-layout:fixed; >
            ...
            <tr>
              ...
              <tr>
                ...
                <td>
                    <input class="easyui-validatebox" id="flowflag" type="text"  data-options="required:true,validType:['length[1,50]']" style="width: 230px; height: 30px;"/>
                </td>              
            </tr>
            <tr>
                <td class="title" style="width: 110px;" >
                ...
                <td>
                    ...
                    <select id="com_FlowLineType" class="easyui-combobox" style="width: 230px; height: 25px;"
    ...
    <script>
        ...
        $(function () {
            ...
            $('.topaddBtn').first().click(function () {
                isEdit = false;
                $('#fl_name').removeAttr("readonly");
                $('#flowflag').removeAttr("readonly");               
                $('#w').window('open');
            });
            ...
            $('.toppenBtn').first().click(function () {
                isEdit = true;
                initEidtWidget();
                $('#fl_name').attr("readonly", "readonly");
                $('#flowflag').attr("readonly", "readonly");
            });
            ...
            dg = $('#tb').datagrid({
                ...
                columns: [[
                      ...
                      { field: 'flowflag', title: '线名缩写', width: 100, align: "center"},
        ...
        function reloadfl_ids() {
            var type = 13;
            $('#com_FlowLineType').combobox('reload', '/HttpHandlers/ProductHandler.ashx?method=queryProductForEditing&type=' + type);
        }
        /****************       主要业务程序          ***************/
