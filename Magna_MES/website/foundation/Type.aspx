<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" Inherits="website.foundation.Type" ValidateRequest="false" Codebehind="Type.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- 数据表格  -->
    <table id="tb" title="车型列表" style="width: 99%;">
    </table>
    <!-- 编辑窗口 -->
    <div id="w" style="padding: 10px; visibility: hidden" title="车型编辑">
    ...
    <script>
        ...
        $(function () {
            ...
            //数据列表加载
            dg = $('#tb').datagrid({
                url: "/HttpHandlers/ColorHandler.ashx?method=queryRateForEditing",
                rownumbers: true,
                pagination: true,
                pageSize: 20,
                rownumbers: true,
