    ...
    <div id="w" style="padding-left: 24px;;padding-top:35px; visibility: hidden" title="产品编辑">
        <table cellpadding="0" cellspacing="0" table-layout:fixed; >
            ...
            <tr>
                ...
                <td>
                      <select id="com_ProductType" class="easyui-combobox" style="width: 230px; height: 25px;"
                   ...
                   <%-- <select id="com_ProductType" class="easyui-combobox" style="width: 100px; height: 25px;"
                        ...
                        <option value="4">60%靠背</option>
                        <option value="5">40%靠背</option>
                    </select>--%>
    ...
    <script>
        ...
        $(function () {
            ...
            $('.toppenBtn').first().click(function () {
                isEdit = true;
                initEidtWidget();
                $('#ProductNo').attr("readonly", "readonly");
            });
            ...
            dg = $('#tb').datagrid({
                ...
                columns: [[
                      ...
                      { field: 'ProductDesc', title: '产品描述', width: 100, align: "center" },
        ...
        function saveProduct() {
            ...
            var ProductTypeName = $('#com_ProductType').combo('getText');
        ...
        function initEidtWidget() {
            ...
            $('#com_ProductType').combobox('setValue', row.ProductTypeName);
        ...
        function reloadfl_ids() {
            var type = 12;
            $('#com_ProductType').combobox('reload', '/HttpHandlers/ProductHandler.ashx?method=queryProductForEditing&type=' + type);
        }
