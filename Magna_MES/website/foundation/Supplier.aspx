<%@ Page Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" Inherits="website.foundation.Supplier" ValidateRequest="false" Codebehind="Supplier.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="top">
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td><span class="title">供应商配置</span>
    ...
    <!-- 数据表格  -->
    <table id="tb" title="供应商列表" style="width: 99%;">
    </table>
    <!-- 编辑窗口 -->
    <div id="w" style="padding: 10px; visibility: hidden" title="供应商编辑">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#fl_id_s").combobox({
                onChange: function (n, o) {
                    dg = $('#tb').datagrid({
                        url: "/HttpHandlers/ColorHandler.ashx?method=queryColorList&id="+n,
                        rownumbers: true,
                        pagination: true,
                        pageSize: 20,
                        rownumbers: true,
            ...
            //数据列表加载
            dg = $('#tb').datagrid({
                url: "/HttpHandlers/ColorHandler.ashx?method=queryColorList&id=1",
                rownumbers: true,
                pagination: true,
                pageSize: 20,
                rownumbers: true,
        ...
        function reloadfl_ids() {
            $('#fl_id_s').combobox('reload', '/HttpHandlers/ColorHandler.ashx?method=queryFlowlingForEditing');
        }
