...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="w" style="padding-left: 24px;;padding-top:35px; visibility: hidden" title="部件编辑">
        <table cellpadding="0" cellspacing="0" table-layout:fixed; >
            ...
            <tr>
                ...
                <td>
                    <select id="part_type" class="easyui-combobox" style="width: 200px; height: 25px;padding-left:15px;"
    ...
    <script>
        ...
        $(function () {
                ...
                $('#FlowLine').combobox(
          {
            ...
            $('.toppenBtn').first().click(function () {
                isEdit = true;
                initEidtWidget();
                $('#part_no').attr("readonly", "readonly");
            });
        ...
        function reloadfl_ids() {
            var type = 12;
            $('#part_type').combobox('reload', '/HttpHandlers/ProductHandler.ashx?method=queryProductForEditing&type=' + type);           
        }
