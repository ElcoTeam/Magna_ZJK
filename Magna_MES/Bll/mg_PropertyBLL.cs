...
namespace Bll
{
    public class mg_PropertyBLL
    {
        ...
        public static string queryColorForEditing(string id)
        {
        ...
        {
            string jsonStr = "[]";
            List<Mg_PropertyTypeModel> list = mg_PropertyDAL.QueryFlowlingForEditing();
            jsonStr = JSONTools.ScriptSerialize<List<Mg_PropertyTypeModel>>(list);
            return jsonStr;
        }
